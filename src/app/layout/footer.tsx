...
const Footer = () => {
  return (
    <div className='flex items-center justify-center py-20 text-neutral-950 border-t border-neutral-300'>
      <div className='max-w-300 px-4 mx-auto flex items-center justify-center flex-col'>
        ...
        <p className='text-md font-semibold mb-10'>
